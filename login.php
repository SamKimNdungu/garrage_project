    ...
    <body class="container">
        ...
        <form action="index.php" class="page-header jumbotron container">
            <div class=" form-group">
                ...
                <input type="email" required="required" name="usr" class="form-control" placeholder="Email Address">
                <br>
                <small class="text-danger">Your Email won't be shared to any third party entity</small>
            </div>
            <div class=" form-group ">
